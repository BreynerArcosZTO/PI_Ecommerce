                    ...
                    <div class="trust-item">
                        <span class="trust-icon">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0_23233_13345" patternContentUnits="objectBoundingBox"
                                        width="1" height="1">
                                        <use xlink:href="#image0_23233_13345" transform="scale(0.00195312)" />
                                    </pattern>
                                    <image id="image0_23233_13345" width="512" height="512"
                    ...
                    <div class="trust-item">
                        <span class="trust-icon">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0_23233_13350" patternContentUnits="objectBoundingBox"
                                        width="1" height="1">
                                        <use xlink:href="#image0_23233_13350"
                                            transform="translate(-0.02 -0.02) scale(0.00203125)" />
                                    </pattern>
                                    <image id="image0_23233_13350" width="512" height="512"
                                        preserveAspectRatio="none"
                    ...
                    <div class="trust-item">
                        <span class="trust-icon">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0_23233_13355" patternContentUnits="objectBoundingBox"
                                        width="1" height="1">
                                        <use xlink:href="#image0_23233_13355" transform="scale(0.00195312)" />
                                    </pattern>
                                    <image id="image0_23233_13355" width="512" height="512"
                                        preserveAspectRatio="none"

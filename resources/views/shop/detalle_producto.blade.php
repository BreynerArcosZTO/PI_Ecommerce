...
<style>
    ...
    .toggle-icon { font-size: 0.9rem; margin-left: auto; padding-right: 4px; }

    .breadcrumb { padding: 14px 30px; font-size: 0.75rem; color: #999; }
    .breadcrumb a { color: #5c3deb; text-decoration: none; }
    ...
    .thumb.active { border-color: #5c3deb; }
    .thumb img { width: 100%; height: 100%; object-fit: cover; }
    .thumb-placeholder { font-size: 1.6rem; color: #ccc; }
    ...
    .main-image img { width: 100%; height: 100%; object-fit: cover; border-radius: 12px; }
    .main-image-placeholder { font-size: 5rem; color: #ddd; }

    .product-info { padding: 0 0 0 30px; }
    .stars { color: #f5a623; font-size: 0.85rem; }
    .review-count { color: #999; font-size: 0.75rem; margin-left: 6px; }
    .product-info h1 { font-size: 1.5rem; font-weight: 600; margin: 6px 0 4px; line-height: 1.3; }
    .sku { font-size: 0.72rem; color: #aaa; margin-bottom: 10px; }

    .price-row { display: flex; align-items: center; gap: 12px; margin-bottom: 6px; }
    .price { font-size: 1.4rem; font-weight: 700; color: #1f1f1f; }
    .badge-sale {
      background: #ff4c4c; color: #fff;
      font-size: 0.65rem; font-weight: 600;
      padding: 3px 8px; border-radius: 20px;
    }
    .free-returns { font-size: 0.75rem; color: #5c3deb; font-weight: 500; }
    ...
    .include-item { display: flex; align-items: center; gap: 6px; font-size: 0.75rem; color: #444; }
    .include-dot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; }
    .dot-blue  { background: #ffccbc; }
    ...
    .payment-option { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }
    .radio-btn {
      width: 16px; height: 16px;
      border: 2px solid #ffccbc; border-radius: 50%;
      display: flex; align-items: center; justify-content: center; flex-shrink: 0;
    }
    .radio-inner { width: 8px; height: 8px; border-radius: 50%; background: #5c3deb; }
    .payment-label { font-size: 0.82rem; font-weight: 500; }
    .badge-discount {
      background: #fff3e0; color: #f57c00;
      font-size: 0.65rem; font-weight: 600;
      padding: 2px 8px; border-radius: 20px; margin-left: 6px;
    }
    .payment-methods { display: flex; gap: 6px; align-items: center; margin-left: auto; }
    .pay-icon {
    ...
    .online-save-row { display: flex; justify-content: space-between; align-items: center; }
    .online-badge {
      background: #ffccbc; color: #fff;
      font-size: 0.68rem; font-weight: 600;
      padding: 3px 10px; border-radius: 20px;
    }
    .online-price { font-size: 0.85rem; font-weight: 700; }
    .save-note { font-size: 0.68rem; color: #5c3deb; margin-top: 4px; }

    .delivery-option { display: flex; align-items: center; gap: 10px; font-size: 0.78rem; color: #888; }
    .radio-empty { width: 16px; height: 16px; border: 2px solid #ccc; border-radius: 50%; flex-shrink: 0; }
    .delivery-link { font-size: 0.72rem; color: #5c3deb; margin-left: auto; cursor: pointer; }
    .delivery-note { font-size: 0.7rem; color: #aaa; margin-top: 6px; }
    .delivery-note a { color: #5c3deb; text-decoration: none; }
    ...
    .btn-cart:hover { background: #ffccbc; transform: translateY(-2px); }
    ...
    .trust-icon { font-size: 1.4rem; flex-shrink: 0; margin-top: 2px; }
    .trust-text strong { display: block; font-size: 0.75rem; font-weight: 600; }
    .trust-text span { font-size: 0.68rem; color: #888; line-height: 1.4; }

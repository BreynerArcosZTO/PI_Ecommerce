                ...
                <div class="payment-box">
                    <div class="payment-option">
                        ...
                        <div class="payment-methods">
                            <span class="pay-icon">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40" height="50"
                                    viewBox="0 0 474 247">
                                    <path
                                        d="M15.3 55.1c-1.7 1.7-1.8 20-.1 21.7 1.6 1.6 22 1.6 23.6 0 .8-.8 1.2-4.7 1.2-11 0-8.2-.3-9.9-1.7-10.6-2.9-1.5-21.6-1.5-23-.1m43.4.1c-1.6 1.2-1.7 5.4-1.5 55.3l.3 54 10.9.3c8.1.2 11.2-.1 11.8-1 .4-.7.8-16.8.8-35.6 0-27.1.3-34.3 1.3-34 .6.3 9.8 15.7 20.2 34.4 10.5 18.7 19.4 34.5 19.8 35.2 1.1 1.7 29.8 1.7 31.5 0 .9-.9 1.2-14.2 1.2-53.8 0-61.7 1.2-56-12.1-56-5.3 0-9.2.5-10.2 1.2-1.5 1.2-1.7 4.7-1.9 34.7-.2 21.2-.7 33.5-1.3 33.7-.5.2-3.5-4.3-6.6-9.9-16-29.2-31.4-56.4-32.7-58-1.3-1.5-3.4-1.7-15.7-1.7-9.7 0-14.6.4-15.8 1.2m137.8 27.7c-21.9 5.7-34 27.5-29.4 52.7 3.9 21 21.3 33.6 44.3 32.1 17.2-1.1 30.3-9.8 34.7-22.9 2-6.1 1.1-6.8-8.6-6.8H229l-2.6 4c-3.2 4.8-5.9 6.7-11.8 8s-13.6-.3-17.8-3.8c-3.7-3.1-6.7-9.4-6.8-13.9V129l28.8-.2 28.7-.3-.1-8.6c-.1-7.4-.5-9.4-3.3-15.6-4-8.7-10.4-15.2-18.6-19-5.1-2.3-7.5-2.8-16-3-5.5-.1-11.3.2-13 .6m21.1 18.6c3.1 2 6.4 7.3 6.4 10.2 0 2.3-.1 2.3-16.5 2.3-10.7 0-16.5-.4-16.5-1 0-4.5 5.6-11.4 10.6-13 4-1.3 13.1-.5 16 1.5m66.8-18.6c-12.5 3-22 13.4-26 28.4-2.1 7.8-1.8 22.2.6 29.8 4.7 15.5 14.8 24.2 29.4 25.6 7.6.7 16-1.5 22.2-5.8 2.4-1.6 4.5-2.9 4.8-2.9s.7 7.5.8 16.7l.3 16.8 10.4.3c6.7.2 10.8-.1 11.7-.9 1.2-1 1.4-9.8 1.4-52.9s-.2-51.9-1.4-52.9c-.9-.8-5-1.1-11.7-.9l-10.4.3-.3 3.2c-.3 3-1.6 4.4-2.4 2.5-.1-.4-1.8-1.8-3.6-3.1-6.1-4.3-17.6-6.1-25.8-4.2m22.7 18.7c8.2 4.2 12 18.7 8.8 33.5-3.9 18.3-27.6 19.4-33.5 1.6-1.2-3.6-1.5-7.3-1.2-14.1.6-13 4-19.1 12.5-22.2 4.1-1.5 9.1-1.1 13.4 1.2M351 86.1c-.9 1.5-1.1 9.9-.8 28.8.4 24.9.6 27 2.7 32.6 3.4 8.8 9.9 14.8 19.1 17.6 6.1 1.8 8.9 2.1 18.8 1.7 9.9-.3 12.6-.8 17.2-2.9 8.9-4.2 14-10.3 16.6-20.4 1.4-5.2 2.1-54.6.8-57.9-.5-1.3-2.5-1.6-11.5-1.6-10.4 0-10.9.1-11.4 2.2-.2 1.3-.6 13.3-.7 26.8-.3 27.4-.8 29.3-7.2 32.4-7 3.3-14.8 1-18.3-5.6-1.5-2.8-1.8-7-2.3-29.3l-.5-26-10.7-.3c-10.1-.2-10.8-.1-11.8 1.9m86-.2c-.6 1.3-1 15.3-1 38.6s.4 37.3 1 38.6c1 1.7 2.2 1.9 11.5 1.9s10.5-.2 11.5-1.9c.6-1.3 1-15.3 1-38.6s-.4-37.3-1-38.6c-1-1.7-2.2-1.9-11.5-1.9s-10.5.2-11.5 1.9" />
                                </svg>
